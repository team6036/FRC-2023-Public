...
public class ConeStationSideAuto implements AutoBase {
  ...
  public RoutineBase getRoutine() {
    ...
    PathPlannerTrajectory traj3 = PathPlanner.loadPath("TestPathBackOffWithGrab", 4, 2.5);
    ...
    var placeHigh =
        new SequentialRoutine(
            ...
            new ParallelRoutine(
                new SequentialRoutine(
                    new TimedRoutine(0.2), new GripperSet(Gripper.State.SPIT, 0.3)),
    ...
    var t4 = new DrivePathRoutine(traj4);
    ...
    return new SequentialRoutine(
        ...
        new ParallelRoutine(
            ...
            new SequentialRoutine(
                ...
                new ParallelRoutine(
                    new VisionSetOverride(0.1, true), new MoveToCubeIntake().getRoutine()))),
        new ParallelRoutine(new MoveBackFromIntake().getRoutine(), t4),
